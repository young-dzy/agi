...
// 数据来源：memory.Preference（高优先级，稳定身份信息）+ LTM 中 category=identity|preference 的条目
...
func NewProfileSource(pref *memory.Preference, ltm *memory.LongTerm) *ProfileSource {
